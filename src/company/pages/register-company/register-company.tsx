      ...
      <div className="flex relative flex-col items-center">
        <div className="relative w-full h-[300px] text-center flex flex-col">
          ...
          <div className="relative z-10 text-white mt-16">
            ...
            <div>
              IT connected is ready to provide the right solution <br />{" "}
          ...
          <div className="">
            <form className="">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  <Input
                    name={"text"}
                    title={"Website"}
                    placeholder={"1xbet.com"}
                  />
                </div>

                <div className="flex flex-col justify-start items-start">
                  <label htmlFor="" className="text-[#757575] font-semibold">
                    Industry
                  </label>
                  <Space wrap>
                    <Select
              ...
              <div className="col-span-3 flex justify-center mt-10">
                <button
                  type="submit"
                  className="bg-blue-500 text-white rounded-md py-2 px-10 hover:bg-blue-600"
                >
                  Submit
                </button>
              </div>
